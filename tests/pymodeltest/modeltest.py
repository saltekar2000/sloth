...
class ModelTest(QtCore.QObject):
    def __init__(self, _model, parent):
        ...
        self.model.columnsInserted[QModelIndex, int, int].connect(self.runAllTests)
        ...
        self.model.rowsInserted[QModelIndex, int, int].connect(self.runAllTests)
        ...
        self.model.rowsInserted[QModelIndex, int, int].connect(self.rowsInserted)
